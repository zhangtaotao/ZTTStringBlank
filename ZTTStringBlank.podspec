#
#  Be sure to run `pod spec lint ZTTStringBlank.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "gwdcl"
  # s.authors            = { "gwdcl" => "gwdcl@yutong.com" }
  # s.social_media_url   = "http://twitter.com/gwdcl"
  ...
  s.exclude_files = "ZTTStringBlank/Exclude"

  # s.public_header_files = "ZTTStringBlanks/**/*.h"
